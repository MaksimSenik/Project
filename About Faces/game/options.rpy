...
define config.name = _("About Faces")
...
define gui.about = _p("""По всем вопросам в тг @Kibakushibari

Давайте скинемся разрабу на второй монитор.
Ему больно кодить.
""")
...
define config.save_directory = "AboutFaces-1697320267"
