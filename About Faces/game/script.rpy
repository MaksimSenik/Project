...
label start:
    ...
    "*Вибрация телефона*"
    nika "*Ну кто там ещё?!*"
    "(Поднимает телефон с кровати)"
    "На всё таком же радостно светящем экране, высветилось имя Алиса"
    nika "*Хм... Тётя Алиса, давненько я её не слышала и не видела. С чего это вдруг, она решила позвонить?"
    "Задумываясь, вспоминает детство*"
    nika "*Помню, ещё в детстве, в лет пять-шесть, гуляла с Тётей и это было восхитительно*"
    nika "*Мы не заботились ни о чём*"
    nika "*Мы могли гулять бесконечно*"
    nika "*Есть огромное количество шоколадного мороженного*"
    nika "*Но потом они посорились с мамой и я надолго осталась без всего этого*"
    nika "*Ладно, сейчас необходимо сконцентрироваться на реальности*"
    "(Принимает вызов)"
    alice "Ника, солнце моё ненаглядное, привет."
    nika "Здравствуйте, тётя Алиса! Как ваши дела?"
    alice "У меня дела прекрасно, а у тебя как дела обстоят?"
    nika "Всё хорошо, папа работает очень много, к сожелению не так частоо его вижу, как хотелось бы"
