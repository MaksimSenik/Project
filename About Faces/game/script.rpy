...
label story:
    ...
    nika "*Быть может, даже смерть в молодом возрасте.*"
    ...
    nika "Фырк"
    nika "А сегодня мне тетя позвонила. Сказала, что у ее друга не хватает аниматора в штате."
    nika "Я уже правда клоуном готова вырядиться"
    nika "достали меня эти оценивающие встречи. А там я сразу по рекомендации пропишусь."
    sava "Ха-ха, да тебе даже наряжаться не нужно!"
    nika "(Смотрит сердито)"
    ...
    nika "*У меня не получится развлекать людей, так что и обнадеживать себя не стоит.*"
