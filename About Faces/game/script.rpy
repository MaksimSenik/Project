...
define nurse = Character('Медсестра', color="DB7093")
...
label story:
    ...
    nika "*Казалось, что если я начну об этом думать, то прогоню все мысли мирового масштаба*"
    ...
    play sound "zanaveska.mp3"
    "(Приоткрывает окно)"
    play sound "otkritie_okna.mp3"
    "На улице солнечно"
    "Ни намёка на тучи"
    nika "*Лицо обдаёт приятный прогретый воздух*"
    nika "*Не люблю я такое*"
    nika "*Был бы дождь*"
    nika "*Осталась бы дома*"
    ...
    stop sound
    "Мысли резко перебивает вибрация телефона"
