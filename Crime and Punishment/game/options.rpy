...
define config.name = _("Crime and Punishment")
...
define gui.about = _p("""Приветствую, я разработчик данной игры, она создана для фестиваля русской литературы и не несёт никакого образовательного характера, безусловно оригинальная ветка взята из произведения, но даже в ней есть изменения для более простого и понятного восприятия, поэтому не рекомендую использовать данную версию сюжета для понимания произведения, лучше сесть и прочитать всё самому.
...
define build.name = "CrimeandPunishment"
...
define config.main_menu_music = "ambient.mp3"
...
default preferences.afm_time = 22
...
define config.save_directory = "CrimeandPunishment-1715796096"
