...
define gui.text_font = "diamondgirlskinny__skinny.otf"

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "diamondgirlskinny__skinny.otf"

## Шрифт, используемый текстом вне игры.
define gui.interface_text_font = "diamondgirlskinny__skinny.otf"
